# -*- coding: utf-8 -*-
"""Copy of ChildRescue_pdfchatbot.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qfHw04mYNjFvgQw_Hj0KItHA0l5Cpm3x
"""
...
def load_model():
    llm = LlamaCpp(
        model_path="F:/mistral-7b-instruct-v0.2.Q2_K.gguf",
        #n_batch=1024,
        temperature=0.75,
        n_ctx=4096,
    ...
    # for loading model using hugging face api key
...
def get_model_qa(vector_store):
    llm = load_model()
    qa = RetrievalQA.from_chain_type(llm=llm, chain_type="stuff", retriever=vector_store.as_retriever(search_kwargs={"k": 2}))
    return qa

def process_file(selected_category, file):
    ...
    if selected_category not in category_prompts:
        print(f"Invalid category: {selected_category}")
        return
...
if __name__ == "__main__":
    ...
    FILE_PATH = "/content/sample_data/Data/story1.pdf"
    ...
    while True:
      ...
      if selected_category == '':
        continue
      result = process_file(selected_category, FILE_PATH)
      if result:
