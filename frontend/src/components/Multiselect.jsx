...
const Multiselect = ({ value, onChange, items, selectedItems1 }) => {
    // state showing if dropdown is open or closed
    const [dropdown, setDropdown] = useState(false);
    const [selectedItems, setSelectedItems] = useState(selectedItems1);
    ...
    const addTag = (item) => {
      ...
      // useEffect to call onChange when selectedItems changes
      useEffect(() => {
            ...
            <div className="autocomplete">
                <div className="w-full flex flex-col items-center mx-auto">
                    <div className="w-full">
                        ...
                        {dropdown && <Dropdown list={items} addItem={addTag} />}
                    </div>
                </div>
            </div>
        </div>
