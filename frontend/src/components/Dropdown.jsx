...
//     <div
//       id="dropdown"
//       className="absolute shadow top-full bg-white z-40 left-0 rounded overflow-y-auto"
//       style={{ width: '100%' }} // Set width to 100% to match the width of the parent container
//     >
//       <div className="flex flex-col w-full">
//         {list.map((item, key) => (
//           <div
